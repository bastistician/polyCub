...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "figures/", dev = "png", dpi = 96, fig.width = 7, fig.height = 5
)
```
...
text(3, 2, labels = "\u222B", cex = 4)  # Unicode integral symbol
```
...
```{R example, fig.cap = "Example", fig.width = 4.5, fig.height = 3.75}
