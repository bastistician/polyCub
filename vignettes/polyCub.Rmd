...
This leads to `nGQ = 4` for the SV-method and a 1200 x 1200 pixel image
required for the midpoint rule.
...
The median runtimes of the different cubature methods are given below.
...
A disadvantage is that the number of cubature nodes needs to be tuned
manually. This also holds for the midpoint rule, which is by far the
